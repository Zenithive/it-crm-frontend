...
//     designation: string;
//   };
//   toggleSidebar: () => void; // Add this to receive the toggle function
//   isSidebarOpen: boolean; // Add this to know the sidebar state
// }

// const Navbar: React.FC<NavbarProps> = ({ nav,toggleSidebar, isSidebarOpen  }) => {
...
//           <img src="hamburger.svg" alt="icon" className=" h-7"   onClick={toggleSidebar} />
