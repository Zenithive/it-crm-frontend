    ...
    <>
      <div className="pt-[48px] flex justify-between items-center px-[70px]">
            ...
            <div className="flex gap-5 items-center justify-start">
              ...
              >
                <img 
                  src={data.Listlogo} 
                  alt="List View" 
                  className={`h-7 w-7 ${activeView === 'list' ? 'opacity-100' : 'opacity-50'}`}
                />
                {activeView === 'list' && (
              ...
              >
                <img 
                  src={data.Kanbanlogo} 
                  alt="Kanban View" 
                  className={`h-7 w-7 ${activeView === 'kanban' ? 'opacity-100' : 'opacity-50'}`} 
                />
                {activeView === 'kanban' && (
        ...
        <HeaderButtons
          ...
          onClick2={showLeadModal} // Add this to handle button click
          onClick1={onFilter}
        />
      </div>

      {/* Modified AddLeadModal Component */}
